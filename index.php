   ...
   <body class="main-layout">
      ...
      <section >
         <div class="banner-main">
            ...
            <div class="container">
               <div class="text-bg">
                  <h1>GauchoRocket<br><strong class="white"> Turismo espacial</strong></h1>
                  <br> <br>
                  <div class="container">
                           ...
                           <div class="col-md-9">
                              <div class="row">
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    ...
                                    <label >Destino</label>
                                    <select class="form-control" name="Any">
                                       <option>Est. Esp.Internacional</option>
                                       <option>OrbiterHotel</option>
                                       <option>Luna</option>
                                       <option>Marte</option>
                                       <option>Ganimedes</option>
                                       <option>Europa</option>
                                       <option>Lo</option>
                                       <option>Encedalo</option>
                                       <option>Titan</option>
                                    </select>
                                 </div>
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
      ...
      <div id="travel" class="traveling">
         <div class="container">
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     <h2>Mejores vuelos</h2>
                     <span>Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure thereThere are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there</span> 
                  </div>
               </div>
            </div>
            <div class="row">
